...
async function ensureColumns() {
  const cols = [
    ...
    `ALTER TABLE documents          ADD COLUMN IF NOT EXISTS monday_doc_item_id    TEXT`,
    `ALTER TABLE documents          ADD COLUMN IF NOT EXISTS pdf_content           BYTEA`,
    `ALTER TABLE documents          ADD COLUMN IF NOT EXISTS signed_pdf_content    BYTEA`,
